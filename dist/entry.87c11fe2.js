...
var mainTemplate = '<h1>{{title}}</h1>' + '<div>{{body}}</div>';
var articleTemplate = '<h3>{{title}}<h3>' + '<span>{{description}}<span></br>' + '<span>{{content}}';
var articleDTOTemplate = '<h3>{{title}}<h3>' + '<span>{{description}}<span>';
var body = null;
...
var _default = {
  showArticle: function showArticle(article) {
    ...
    for (var i in article) {
      articleStr = articleStr.replace('{{' + i + '}}', article[i]);
    }
...
exports.default = _default;
},{"./constants":"lib/js/constants.js"}],"../node_modules/navigo/lib/navigo.min.js":[function(require,module,exports) {
var define;
...
router.on({
  'article/:id': function articleId(params) {//  alert('Products'+ params.id);
  },
  'articles': function articles() {//alert('articles');
  },
  '*': function _() {//alert('Home')
  }
}).resolve();
},{"./templates":"lib/js/templates.js","navigo":"../node_modules/navigo/lib/navigo.min.js"}],"../../../Users/ionuts/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../Users/ionuts/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"entry.js":[function(require,module,exports) {
"use strict";
...
var init = function init() {
  _templates.default.showArticle(article);
};

(0, _jquery.default)(document).ready(init);
},{"./lib/js/myQuery.js":"lib/js/myQuery.js","./lib/css/main.css":"lib/css/main.css","./lib/js/constants":"lib/js/constants.js","./lib/js/router":"lib/js/router.js","./lib/js/templates":"lib/js/templates.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../../../Users/ionuts/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
