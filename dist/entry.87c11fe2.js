...
exports.mainContent = exports.backendApiAddress = void 0;
...
},{"./constants":"lib/js/constants.js"}],"lib/js/startingObject.js":[function(require,module,exports) {
"use strict";
...
var _startingObject = _interopRequireDefault(require("./startingObject"));
...
router.on({
  ...
  'article/create': function articleCreate() {// alert('articles');
  },
  '*': function _() {
    _templates.default.showStartPage(_startingObject.default);
  }
}).resolve();
},{"navigo":"../node_modules/navigo/lib/navigo.min.js","./templates":"lib/js/templates.js","./startingObject":"lib/js/startingObject.js"}],"entry.js":[function(require,module,exports) {
"use strict";
